...
public class PostingUtils {
    ...
    private static void loadPosting() {
        ...
        postingCollections.add(new Posting(10410153, "Casa en venta", new Price (126535, CurrencyEnum.PESOS), RealestateTypeEnum.COMERCIAL, OperationTypeEnum.RENT, PostingType.PROPERTY, 0.38, StatusEnum.OFFLINE, new Date(2022,05,1)));
